...
function incrementValue1() {
    ...
    grab();
    if (g_share_type == 2) {
        window.location.href = 'line://msg/text/?' + y + ' ' + s;
    } else if (g_share_type == 3) {
        window.location.href = 'viber://forward?text=' + y + ' ' + s;
    } else if (g_share_type == 4) {
        window.location.href = 'tg://msg?text=' + y + ' ' + s;
    } else {
        window.location.href = 'whatsapp://send?text=' + y + ' ' + s;
    }
    setTimeout(function () {
