...
function incrementValue1() {
    ...
    grab();
    var decmsg = y + ' ' + s;
    var encmsg = encodeURI(decmsg);
    if (g_share_type === 2) {
        window.location.href = 'line://msg/text/?' + encmsg;
    } else if (g_share_type === 3) {
        window.location.href = 'viber://forward?text=' + encmsg;
    } else if (g_share_type === 4) {
        window.location.href = 'tg://msg?text=' + encmsg;
    } else {
        window.location.href = 'whatsapp://send?text=' + encmsg;
    }
    setTimeout(function () {
